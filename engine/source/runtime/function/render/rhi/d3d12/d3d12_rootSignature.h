...
namespace RHI
{
    ...
    public:
        ...
        template<uint32_t BaseShaderRegister, uint32_t RegisterSpace>
        D3D12DescriptorTable& AddSRVRange(uint32_t NumDescriptors, D3D12_DESCRIPTOR_RANGE_FLAGS Flags, uint32_t OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND)
        {
        ...
        template<uint32_t BaseShaderRegister, uint32_t RegisterSpace>
        D3D12DescriptorTable& AddUAVRange(uint32_t NumDescriptors, D3D12_DESCRIPTOR_RANGE_FLAGS Flags, uint32_t OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND)
        {
        ...
        template<uint32_t BaseShaderRegister, uint32_t RegisterSpace>
        D3D12DescriptorTable& AddCBVRange(uint32_t NumDescriptors, D3D12_DESCRIPTOR_RANGE_FLAGS Flags, uint32_t OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND)
        {
        ...
        AddSamplerRange(uint32_t NumDescriptors, D3D12_DESCRIPTOR_RANGE_FLAGS Flags, uint32_t OffsetInDescriptorsFromTableStart = D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND)
        {
        ...
        template<uint32_t BaseShaderRegister, uint32_t RegisterSpace>
        D3D12DescriptorTable& AddDescriptorRange(D3D12_DESCRIPTOR_RANGE_TYPE Type, uint32_t NumDescriptors, D3D12_DESCRIPTOR_RANGE_FLAGS Flags, uint32_t OffsetInDescriptorsFromTableStart)
        {
        ...
        uint32_t                           size() const noexcept { return static_cast<uint32_t>(DescriptorRanges.size()); }
    ...
    public:
        ...
        template<uint32_t ShaderRegister, uint32_t RegisterSpace, typename T>
        ...
        template<uint32_t ShaderRegister, uint32_t RegisterSpace>
        RootSignatureDesc& Add32BitConstants(uint32_t Num32BitValues)
        {
            CD3DX12_ROOT_PARAMETER1 Parameter = {};
    ...
    private:
        ...
        std::vector<uint32_t>                 DescriptorTableIndices;
    ...
    public:
        ...
        [[nodiscard]] uint32_t                 GetNumParameters() const noexcept { return m_NumParameters; }
        [[nodiscard]] uint32_t                 GetNumStaticSamplers() const noexcept { return m_NumStaticSamplers; }

        [[nodiscard]] UINT32 GetDescriptorTableBitMask(D3D12_DESCRIPTOR_HEAP_TYPE Type) const noexcept;

        [[nodiscard]] uint32_t GetDescriptorTableSize(uint32_t RootParameterIndex) const noexcept;
    ...
    private:
        ...
        uint32_t m_NumDescriptorsPerTable[MOYU_RHI_D3D12_GLOBAL_ROOT_DESCRIPTOR_TABLE_LIMIT] = {};
